...
class PizzasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pizza" do
    assert_difference("Pizza.count") do
      post pizzas_url, params: { pizza: { ingredient: @pizza.ingredient, mediumPrice: @pizza.mediumPrice, name: @pizza.name, smallPrice: @pizza.smallPrice } }, as: :json
    end
  ...
  test "should update pizza" do
    patch pizza_url(@pizza), params: { pizza: { ingredient: @pizza.ingredient, mediumPrice: @pizza.mediumPrice, name: @pizza.name, smallPrice: @pizza.smallPrice } }, as: :json
    assert_response :success
  end
